...
export const REFERENCES: Record<string, Reference> = {
  ...
  "hyperweave": { source: "Poincaré disk model of the hyperbolic plane — geodesics are circular arcs orthogonal to the boundary; Coxeter, H.S.M. (1979) \"The Non-Euclidean Symmetry of Escher's Picture 'Circle Limit III'\", Leonardo 12; the closed coprime walk and its rippled symmetry are this project's own construction", url: "https://en.wikipedia.org/wiki/Poincar%C3%A9_disk_model", doi: ["10.2307/1574078"], original: true },
  ...
  "knot": { source: "Bogle, M.G.V., Hearst, J.E., Jones, V.F.R. & Stoilov, L. (1994) \"Lissajous knots\", Journal of Knot Theory and Its Ramifications 3(2), 121–140; the depth-banded projection and its motions are this project's own construction", url: "https://en.wikipedia.org/wiki/Lissajous_knot", doi: ["10.1142/S0218216594000095"], original: true },
