...
export const UI: Record<string, Pair> = {
  ...
  'anim.stageSec': ['STAGE', 'ESCENA'],
  'anim.audioSec': ['AUDIO', 'AUDIO'],
  'anim.tuning': ['MUSIC RESPONSE', 'RESPUESTA A LA MÚSICA'],
  'anim.snap': ['SNAP', 'VIVEZA'],
  'anim.smoothing': ['SMOOTHING', 'SUAVIZADO'],
  'anim.bass': ['BASS', 'GRAVES'],
  'anim.mid': ['MIDS', 'MEDIOS'],
  'anim.high': ['HIGHS', 'AGUDOS'],
  'anim.tuningReset': ['RESET', 'RESTABLECER'],
  'anim.decodeError': [
